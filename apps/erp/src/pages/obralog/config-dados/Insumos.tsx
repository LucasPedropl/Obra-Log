	...
	const fetchData = async () => {
		...
		try {
			...
			if (!unRes.error && unRes.data) {
				...
				console.error('Error fetching units:', unRes.error);
			}
															...
															return (
																<>
																	{globais.length >
																		0 && (
																		<div>
																			<div className="px-3 py-1 bg-background text-xs font-bold text-text-muted uppercase tracking-wider">
																				Padrões
																			</div>
																			{globais.map(
																				(
																	...
																	{locais.length >
																		0 && (
																		<div>
																			<div className="px-3 py-1 bg-background text-xs font-bold text-text-muted uppercase tracking-wider mt-1">
																				Cadastro
																				Próprio
																			</div>
																			{locais.map(
