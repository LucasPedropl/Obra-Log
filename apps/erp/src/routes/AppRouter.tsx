...
const router = createBrowserRouter([
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.visao_geral"
				requiredAction="view"
			>
				<VisaoGeral />
			</ProtectedRoute>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.almoxarifado"
				requiredAction="view"
			>
				<Almoxarifado />
			</ProtectedRoute>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.ferramentas.disponiveis"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.ferramentas.emprestimos"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.ferramentas.historico"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.colaboradores"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.epis.disponiveis"
				requiredAction="view"
			>
				<EPisDisponiveis />
			</ProtectedRoute>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.epis.historico"
				requiredAction="view"
			>
				<EPisHistorico />
			</ProtectedRoute>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.equip_alugados.ativos"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.equip_alugados.historico"
				requiredAction="view"
			>
	...
	},
	{
		...
		element: (
			<ProtectedRoute
				resourceName="obras.pages.movimentacoes"
				requiredAction="view"
			>
				<Movimentacoes />
			</ProtectedRoute>
