...
ALTER TABLE public.rented_equipments ADD COLUMN IF NOT EXISTS entry_photos_url text; 
ALTER TABLE public.rented_equipments ADD COLUMN IF NOT EXISTS exit_photos_url text; 
